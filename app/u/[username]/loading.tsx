...
export default function PublicProfileLoading() {
  return (
    <>
      <div className="overflow-hidden rounded-[2rem] border border-border-strong card-surface p-6 shadow-card backdrop-blur-xl sm:p-8">
      ...
      <div className="overflow-hidden rounded-[2rem] border border-border-strong card-surface px-6 py-6 shadow-card backdrop-blur-xl sm:px-8 sm:py-7">
