...
export function PublicProfileTimeline({ activities, cardClass }: PublicProfileTimelineProps) {
    ...
    <div className={cardClass}>
      ...
      {supportedActivities.length === 0 ? (
        <div className="mt-6 flex flex-col items-center gap-4 py-10 text-center">
          ...
          <div>
            <p className="text-sm font-medium text-ink-200">No recent activity</p>
            <p className="mt-1 max-w-xs text-sm leading-relaxed text-ink-600">
              Nothing has been shared publicly in the last 30 days.
            </p>
          </div>
        </div>
      ) : (
