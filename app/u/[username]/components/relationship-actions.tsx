      ...
      case "friends":
        return (
          <button
            ...
            disabled={isPending}
            className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface px-5 py-2.5 text-sm font-medium text-ink-200 shadow-card backdrop-blur-xl transition-all duration-300 ease-premium hover:-translate-y-0.5 hover:border-red-400/40 hover:text-red-300 hover:shadow-glow-sm disabled:opacity-50"
          >
        ...
        return (
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              disabled={isPending}
              className="inline-flex items-center gap-2 rounded-full border border-border-strong bg-surface px-5 py-2.5 text-sm font-medium text-ink-300 shadow-card backdrop-blur-xl transition-all duration-300 ease-premium hover:-translate-y-0.5 hover:border-red-400/40 hover:text-red-300 hover:shadow-glow-sm disabled:opacity-50"
            >
