...
export function SettingsPanel({
  ...
  return (
    <div
      className={cn(
        "relative overflow-hidden rounded-2xl border border-white/[0.08] bg-[rgba(10,11,16,0.72)] shadow-card backdrop-blur-xl backdrop-saturate-150 transition-colors duration-300",
        className,
      )}
    >
      <div
