      ...
      <div className="mx-auto max-w-[960px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {PREVIEWS.map((item, i) => {
            ...
            return (
              <div key={item.title} className="group relative flex h-full flex-col overflow-hidden rounded-2xl card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:border-accent-400/40">
