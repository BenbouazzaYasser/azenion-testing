  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-32" aria-labelledby="community-cta-heading">
      <div className="mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        <Reveal>
          <div className="relative overflow-hidden rounded-[2.5rem] border border-border-strong/[0.08] card-surface px-8 py-16 text-center shadow-card backdrop-blur-xl sm:px-16 sm:py-24">
            <div
              aria-hidden
