...
export function LatestFeed({ items }: LatestFeedProps) {
  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-28" aria-labelledby="latest-feed-heading">
        ...
        <Reveal>
          <div className="flex flex-col gap-6 sm:flex-row sm:items-end sm:justify-between">
            <div className="max-w-2xl">
              ...
              >
                Fresh from <span className="text-accent-400">the feed.</span>
              </h2>
              <p className="mt-5 text-[1.02rem] leading-relaxed text-ink-400">
                The most recent updates from teams, projects, branches and members.
              </p>
            </div>
