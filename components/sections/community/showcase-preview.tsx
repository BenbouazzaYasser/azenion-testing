          ...
          {FEATURED.map((item, i) => {
            ...
            return (
              <Reveal key={item.title} delay={i * 100} className="h-full">
                <Link
                  href="/showcase"
                  className="group relative flex h-full flex-col overflow-hidden rounded-[2rem] card-surface p-7 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:shadow-glow-sm"
                >
