  ...
  return (
    <section className="relative py-20 sm:py-24 lg:py-28" aria-labelledby="about-heading">
      <div className="mx-auto max-w-[1320px] px-5 sm:px-8 lg:px-12">
        <Reveal className="mx-auto max-w-5xl rounded-[2rem] border border-border-strong/[0.08] card-surface-soft p-8 shadow-card backdrop-blur-xl sm:p-10 lg:p-14">
          <div className="grid gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
            ...
            <div className="flex flex-col justify-between rounded-[1.4rem] border border-border-strong/[0.08] bg-void-950/70 p-6 sm:p-7">
              <div>
