        ...
        <div className="grid grid-cols-1 divide-y divide-border sm:grid-cols-2 sm:divide-y-0 lg:grid-cols-4 lg:divide-x">
          {(await Promise.all(FEATURE_ITEMS.map(async (feature) => {
            ...
            return (
              ...
              >
                <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-surface text-accent-400 transition-all duration-300 group-hover:scale-[1.02] group-hover:border-accent-400/40 group-hover:bg-accent/[0.06]">
