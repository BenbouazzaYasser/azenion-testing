    ...
    <>
      {mode === "create" ? (
        ...
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-full border border-border-strong/[0.08] text-ink-400 transition-colors hover:border-accent-400/50 hover:text-accent-400"
        >
          <Pencil size={13} />
        </button>
      )}
