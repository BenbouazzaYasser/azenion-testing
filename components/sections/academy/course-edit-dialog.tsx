  ...
  return (
    <>
      <button
        ...
        title="Edit course"
        className="flex h-8 w-8 items-center justify-center rounded-full border border-border-strong/[0.08] text-ink-400 transition-colors hover:border-accent-400/50 hover:text-accent-300"
      >
        <Pencil size={13} />
      </button>
        ...
        ? createPortal(
            ...
            >
              ...
              <div
                ref={dialogFocusRef}
                tabIndex={-1}
                className="relative z-10 flex max-h-[85vh] w-full max-w-[640px] flex-col overflow-hidden rounded-2xl border border-border-strong/[0.08] panel-gradient shadow-dialog backdrop-blur-2xl transition-all duration-200 ease-premium focus:outline-none"
                style={{
                  opacity: mounted ? 1 : 0,
                        ...
                        {previewThumbnail ? (
                          <div className="flex items-center gap-3">
                            ...
                            <img
                              ...
                              className="h-16 w-16 shrink-0 rounded-lg border border-border-strong/[0.08] object-cover"
                            />
                            <button
                              type="button"
                              onClick={() => {
