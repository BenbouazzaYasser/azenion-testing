...
function CourseCard({
  ...
  return (
    <div className="group relative flex flex-col overflow-hidden rounded-2xl border border-border-strong card-surface-soft shadow-card backdrop-blur-xl transition-all duration-300 ease-premium hover:-translate-y-1 hover:border-accent-400/40 hover:shadow-glow">
      <div
        aria-hidden
      ...
      <div className="relative flex flex-1 flex-col p-6">
        ...
        {(course.duration || course.difficulty) && (
          <div className="mt-3 flex flex-wrap items-center gap-2">
            {course.duration ? (
              <span className="inline-flex items-center gap-1.5 rounded-full border border-border-strong bg-surface px-2.5 py-1 text-[11px] font-medium text-ink-400">
                <Clock size={11} />
                {course.duration}
              </span>
            ) : null}
