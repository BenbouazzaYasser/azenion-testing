  ...
  return (
    <div className="flex flex-col items-center gap-3 sm:items-start">
      ...
      >
        ...
        <div className="absolute inset-0 flex items-center justify-center rounded-full bg-void-950/60 opacity-100 backdrop-blur-sm transition-opacity duration-300 sm:opacity-0 sm:group-hover:opacity-100">
          {loading ? (
