  ...
  return (
    <div className="flex flex-col items-center gap-3 sm:items-start">
      <button
        ...
        disabled={loading}
        className="group relative h-24 w-24 overflow-hidden rounded-full border border-accent-400/30 bg-accent/[0.08] transition-colors duration-200 hover:border-accent-400/60 sm:h-28 sm:w-28 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400 focus-visible:ring-offset-2 focus-visible:ring-offset-void-950"
      >
        {preview ? (
          <img
            src={preview}
        ...
        <div className="absolute inset-0 flex items-center justify-center rounded-full bg-void-950/60 opacity-100 backdrop-blur-sm transition-opacity duration-300 group-focus-visible:opacity-100 group-focus-within:opacity-100 sm:opacity-0 sm:group-hover:opacity-100">
          {loading ? (
