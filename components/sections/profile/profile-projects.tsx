          ...
          >
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="mt-0.5 flex flex-wrap items-center gap-x-2 gap-y-1">
                ...
                {project.visibility ? (
                  <span className="inline-flex items-center gap-0.5 rounded-full border border-border-strong bg-white/[0.03] px-1.5 py-0.5 text-[10px] font-medium text-ink-400">
              ...
              {(project.technologies ?? []).length > 0 ? (
                <div className="mt-1.5 flex flex-wrap gap-1">
                  ...
                  {(project.technologies ?? []).length > 3 ? (
                    <span className="inline-flex rounded-full border border-ink-700/50 bg-white/[0.03] px-2 py-0.5 text-[10px] font-medium text-ink-500">
                      +{(project.technologies ?? []).length - 3}
                    </span>
                  ) : null}
                </div>
