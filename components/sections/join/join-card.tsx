          ...
          <div className="group overflow-hidden rounded-2xl card-surface px-6 py-8 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:border-accent-400/40 sm:px-12 sm:py-9">
            ...
            <div className="relative mt-6 flex flex-col gap-3">
              <button
                ...
                disabled
                aria-disabled="true"
                className="relative flex w-full cursor-not-allowed items-center gap-3 rounded-xl bg-surface py-3.5 pl-4 pr-16 text-sm font-medium text-ink-300 opacity-70 backdrop-blur-xl transition-all duration-300 sm:justify-center sm:px-4 sm:pr-20"
              >
                ...
                <span className="absolute right-3 text-[9px] font-medium uppercase tracking-wide text-ink-600 sm:right-4 sm:text-[10px]">
                  Coming soon
                </span>
              </button>
              ...
              >
                <span className="flex min-w-0 items-center justify-center gap-3">
                  ...
                  <span className="leading-snug">Continue with GitHub</span>
                </span>
                <span className="absolute right-3 text-[9px] font-medium uppercase tracking-wide text-ink-600 sm:right-4 sm:text-[10px]">
                  Coming soon
                </span>
