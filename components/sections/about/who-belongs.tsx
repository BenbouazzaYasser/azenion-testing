          ...
          {ROLES.map((role, i) => {
            ...
            return (
              <Reveal key={role.title} delay={i * 50} className="h-full">
                <div className="group relative flex h-full flex-col items-center rounded-2xl border border-border-strong card-surface p-7 text-center shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:shadow-glow-sm">
