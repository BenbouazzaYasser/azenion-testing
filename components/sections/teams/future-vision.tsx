...
export function FutureVision() {
  return (
    <section className="relative overflow-hidden py-28 sm:py-32 lg:py-44" aria-labelledby="future-vision-heading">
        ...
        <Reveal delay={240}>
          <div className="mt-10 grid gap-4 sm:grid-cols-3 sm:gap-6">
            {[
              ...
              <div
                key={item.stat}
                className="group rounded-2xl border border-border-strong bg-[linear-gradient(135deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] p-6 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1 hover:border-accent-400/40 hover:shadow-glow-sm"
              >
