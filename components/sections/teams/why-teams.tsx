      ...
      <div className="mx-auto max-w-[960px] px-5 sm:px-8 lg:px-12">
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {(await Promise.all(REASONS.map(async (reason, i) => {
            ...
            return (
              <div key={reason.titleKey} className="flex">
                <div className="group flex w-full flex-col overflow-hidden rounded-2xl card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:border-accent-400/40">
                  ...
                  <div className="relative flex flex-1 flex-col p-6 sm:p-7">
                    <div className="relative flex h-11 w-11 items-center justify-center rounded-xl bg-surface text-accent-400 transition-all duration-500 ease-premium group-hover:scale-[1.05] group-hover:border-accent-400/40 group-hover:bg-accent/[0.08]">
