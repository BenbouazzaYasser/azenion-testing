        ...
        {projects.length > 0 ? (
          ...
          <Reveal delay={120}>
            <div className="mt-10 flex flex-col items-center gap-4 py-16 text-center">
              ...
              <div>
                <p className="text-sm font-medium text-ink-200">{t("teams.noProjects")}</p>
                <p className="mt-1 max-w-xs text-sm text-ink-600">
                  {canCreateProjects ? t("teams.noProjectsManage") : t("common.checkLater")}
                </p>
              </div>
            </div>
          </Reveal>
