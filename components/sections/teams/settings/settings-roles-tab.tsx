        ...
        return (
          ...
          >
            <div className="flex flex-wrap items-center gap-3 border-b border-border px-5 py-4 sm:px-6">
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full border border-border-strong px-2.5 py-0.5 text-[11px] font-medium text-ink-400">
                <Users size={11} />
              ...
              {canManageRoles ? (
                <div className="ml-auto flex items-center gap-2">
                  <select
                    ...
                    className="rounded-lg border border-border-strong bg-void-900 px-2 py-1 text-xs text-ink-300 outline-none"
                  >
