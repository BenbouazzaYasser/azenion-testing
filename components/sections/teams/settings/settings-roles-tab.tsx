    ...
    <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-end">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl bg-surface px-4 py-3 text-[0.95rem] text-ink-50 placeholder:text-ink-600 outline-none transition-colors focus:border-accent-400/60 focus:bg-surface-hover"
              />
            </div>
            <div>
      ...
      {roles.map((role) => {
        ...
        return (
          <div
            key={role.id}
            className="overflow-hidden rounded-2xl bg-surface shadow-card backdrop-blur-xl"
          >
            <div className="flex flex-wrap items-center gap-3 border-b border-border px-5 py-4 sm:px-6">
              ...
              {editing && canManageRoles ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    maxLength={40}
                    className="rounded-lg bg-surface px-3 py-1.5 text-sm text-ink-50 outline-none focus:border-accent-400/60"
                  />
              ...
              <span className="inline-flex items-center gap-1.5 rounded-full px-2.5 py-0.5 text-[11px] font-medium text-ink-400">
                <Users size={11} />
              ...
              {canManageRoles ? (
                <div className="ml-auto flex items-center gap-2">
                  <select
                    ...
                    className="rounded-lg bg-void-900 px-2 py-1 text-xs text-ink-300 outline-none"
                  >
      ...
      {roles.length === 0 && canManageRoles ? (
        <div className="rounded-2xl bg-surface p-10 text-center shadow-card backdrop-blur-xl">
