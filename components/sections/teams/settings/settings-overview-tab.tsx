...
export function SettingsOverviewTab({
  ...
  return (
    <div className="space-y-8">
      {canEditInfo ? (
        <form onSubmit={handleSave} className="rounded-2xl border border-border-strong/[0.08] bg-surface p-6 shadow-card backdrop-blur-xl sm:p-8">
        ...
        <div className="rounded-2xl border border-border-strong/[0.08] bg-surface p-6 shadow-card backdrop-blur-xl sm:p-8">
          ...
          <div className="mt-6 grid gap-6 sm:grid-cols-2">
            <div>
              ...
              <div className="flex h-28 w-28 items-center justify-center overflow-hidden rounded-2xl border border-border-strong/[0.08] bg-surface">
                {team.logo_url ? (
            ...
            <div>
              ...
              <div className="flex h-28 w-full items-center justify-center overflow-hidden rounded-2xl border border-border-strong/[0.08] bg-surface">
                {team.banner_url ? (
                  // eslint-disable-next-line @next/next/no-img-element
