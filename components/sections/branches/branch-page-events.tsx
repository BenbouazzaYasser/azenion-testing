  ...
  function renderEvent(event: BranchEvent, i: number) {
    ...
    return (
      <Reveal key={event.id} delay={i * 60} className="h-full">
        <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border-strong/[0.08] card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:shadow-glow-sm sm:flex-row">
          {event.cover_url ? (
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="min-w-0">
                <div className="flex flex-wrap items-center gap-2">
                  <span className="inline-flex items-center gap-1.5 rounded-full border border-border-strong/[0.08] bg-surface px-2.5 py-0.5 text-[11px] font-medium text-ink-400">
                    {branchLogoUrl ? (
                  ...
                  {event.visibility === "public" ? (
                    <span className="inline-flex items-center gap-1 rounded-full border border-border-strong/[0.08] bg-surface px-2.5 py-0.5 text-[11px] font-medium text-ink-400">
                      <Globe size={10} />
                      Public
                    </span>
                  ) : (
  ...
  return (
    <section className="relative py-16 sm:py-20 lg:py-24" aria-labelledby="branch-events-heading">
      <div className="mx-auto max-w-[960px] px-5 sm:px-8 lg:px-12">
        ...
        {showForm ? (
          <Reveal delay={120}>
            <div className="mt-8 overflow-hidden rounded-2xl border border-border-strong/[0.08] card-surface p-6 shadow-card sm:p-8">
