      ...
      <div className="mx-auto max-w-[1200px] px-5 sm:px-8 lg:px-12">
        <div className="grid gap-14 lg:grid-cols-[1fr_1.2fr] lg:gap-20">
                ...
                return (
                  <Reveal key={channel.label} delay={i * 60}>
                    <a
                      ...
                      className="group relative flex items-center gap-4 overflow-hidden rounded-2xl border border-border-strong/[0.08] card-surface p-5 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-0.5 hover:border-accent-400/40 hover:shadow-glow-sm sm:p-6"
                    >
          ...
          <div className="flex flex-col justify-center">
            <Reveal delay={80}>
              <div className="group relative overflow-hidden rounded-[2rem] border border-border-strong/[0.08] card-surface p-6 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium sm:p-8 lg:p-10">
                  ...
                  >
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl border border-border-strong/[0.08] bg-surface px-4 py-3.5 text-[0.95rem] text-ink-50 placeholder:text-ink-600 transition-all duration-300 focus:border-accent-400/50 focus:bg-accent/[0.04] focus:outline-none focus:ring-1 focus:ring-accent-400/30"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full resize-none rounded-xl border border-border-strong/[0.08] bg-surface px-4 py-3.5 text-[0.95rem] text-ink-50 placeholder:text-ink-600 transition-all duration-300 focus:border-accent-400/50 focus:bg-accent/[0.04] focus:outline-none focus:ring-1 focus:ring-accent-400/30"
                      />
                    </div>
