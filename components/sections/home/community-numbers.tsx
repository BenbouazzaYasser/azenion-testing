...
function StatCard({ stat, index }: { stat: Stat; index: number }) {
  ...
  return (
    <Reveal delay={index * 100}>
      <div
        ref={ref}
        className="flex flex-col items-center gap-3 rounded-[2rem] border border-border-strong bg-[linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-8 text-center shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:shadow-glow-sm"
      >
