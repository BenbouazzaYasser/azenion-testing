            ...
            {FOCUS_CARDS.map((card, i) => {
              ...
              return (
                <Reveal key={card.title} delay={i * 80} className="h-full">
                  <div className="group relative h-full overflow-hidden rounded-[1.6rem] border border-border-strong bg-[linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-6 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:bg-[linear-gradient(135deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))] hover:shadow-glow-sm sm:p-7">
