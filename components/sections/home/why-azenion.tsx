            ...
            {FOCUS_CARDS.map((card, i) => {
              ...
              return (
                <Reveal key={card.title} delay={i * 80} className="h-full">
                  <div className="group relative h-full overflow-hidden rounded-[1.6rem] border border-border-strong card-surface-soft p-6 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:card-surface hover:shadow-glow-sm sm:p-7">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {PILLARS.map((pillar) => {
              ...
              return (
                <div
                  key={pillar.title}
                  className="group relative overflow-hidden rounded-[1.4rem] border border-border-strong card-surface-soft p-5 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:card-surface hover:shadow-glow-sm"
                >
                  <div className="pointer-events-none absolute -inset-x-4 -inset-y-4 rounded-[1.6rem] bg-[radial-gradient(circle_at_50%_0%,rgba(40,40,255,0.07),transparent_60%)] opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                  <div
                    aria-hidden
