          ...
          {ECOSYSTEM.map((item, i) => {
            ...
            return (
              <Reveal key={item.href} delay={i * 60} className="h-full">
                <Link
                  href={item.href}
                  className="group relative flex h-full flex-col overflow-hidden rounded-[1.6rem] border border-border-strong bg-[linear-gradient(135deg,rgba(255,255,255,0.04),rgba(255,255,255,0.015))] p-7 shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:bg-[linear-gradient(135deg,rgba(255,255,255,0.07),rgba(255,255,255,0.025))] hover:shadow-glow-sm"
                >
