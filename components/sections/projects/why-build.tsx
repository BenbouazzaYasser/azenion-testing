        ...
        <div className="mt-10 grid gap-5 sm:grid-cols-2">
          {(await Promise.all(REASONS.map(async (reason, i) => {
            ...
            return (
                ...
                <div key={reason.titleKey} className="group relative flex h-full flex-col overflow-hidden rounded-2xl card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:border-accent-400/40">
