      ...
      <div className="relative mx-auto max-w-[920px] px-5 text-center sm:px-8 lg:px-12">
        ...
        <Reveal delay={80}>
          ...
          >
            ...
            <span className="text-accent-400">{await serverT("projects.futureTitleAccent")}</span>
          </h2>
        </Reveal>
        ...
        <Reveal delay={320}>
          <p className="mx-auto mt-12 max-w-2xl text-balance text-[1.3rem] font-medium leading-relaxed text-ink-200 sm:text-[1.45rem]">
            ...
            <br />
            <span className="text-accent-400">{await serverT("projects.futureCtaAccent")}</span>
          </p>
        </Reveal>
      </div>
    </section>
