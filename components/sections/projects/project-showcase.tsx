    ...
    <section className="relative py-16 sm:py-20 lg:py-24" aria-labelledby="showcase-heading">
      <div className="mx-auto max-w-[960px] px-5 sm:px-8 lg:px-12">
        ...
        {projects.length > 0 ? (
                  ...
                  <div className="group relative flex h-full flex-col overflow-hidden rounded-2xl border border-border-strong/[0.08] card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:-translate-y-1.5 hover:border-accent-400/40 hover:shadow-glow-sm">
                    ...
                    <div className="relative flex flex-1 flex-col p-6 sm:p-7">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <span className="inline-flex shrink-0 items-center gap-1 rounded-full border border-border-strong/[0.08] bg-surface px-2.5 py-0.5 text-[11px] font-medium text-ink-400">
                          {(() => {
          ...
          <Reveal delay={120}>
            <div className="mt-10 rounded-2xl border border-border-strong/[0.08] card-surface p-14 text-center shadow-card backdrop-blur-xl">
