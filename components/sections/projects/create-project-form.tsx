  ...
  return (
    <section className="relative overflow-hidden pb-24 pt-6 sm:pb-28 lg:pb-36">
      ...
      <div className="mx-auto max-w-[640px] px-5 sm:px-8 lg:px-12">
        <Reveal>
          <div className="overflow-hidden rounded-[2rem] border border-border-strong card-surface p-8 shadow-card backdrop-blur-xl sm:p-10">
            {error ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-7">
              {teams.length > 1 ? (
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 rounded-xl border border-border-strong bg-surface px-4 py-3.5 text-[0.95rem] text-ink-200">
