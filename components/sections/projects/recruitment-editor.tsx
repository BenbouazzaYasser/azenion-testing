  ...
  return (
    <div className="space-y-4">
      {roles.map((role, i) => (
        <div
          key={role.id}
          className="rounded-xl border border-border-strong bg-white/[0.02] p-5 transition-all duration-300"
        >
          <div className="flex items-start justify-between gap-4">
            ...
            <button
              ...
              disabled={disabled}
              className="rounded p-1 text-ink-500 transition-colors hover:bg-white/[0.05] hover:text-red-400 disabled:opacity-40"
            >
              <X size={14} />
            </button>
          </div>
