...
const inputClass =
  "w-full rounded-xl border border-border-strong bg-surface px-4 py-3 text-[0.9rem] text-ink-50 placeholder:text-ink-600 outline-none transition-colors focus:border-accent-400/60 focus:bg-surface-hover focus:shadow-input";
  ...
  return (
    <div className="space-y-4">
      {roles.map((role, i) => (
        <div
          key={role.id}
          className="rounded-xl border border-border-strong bg-surface p-5 transition-all duration-300"
        >
