  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex w-full items-center justify-between gap-2 rounded-xl border border-border-strong/[0.08] bg-surface px-4 py-2.5 text-sm text-ink-200 backdrop-blur-xl transition-all duration-300 ease-premium hover:border-accent-400/40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400 sm:w-auto"
      >
      ...
      {open && (
        <div className="absolute left-0 top-full z-20 mt-1.5 w-full min-w-[160px] overflow-hidden rounded-xl border border-border-strong/[0.08] bg-glass-strong shadow-dropdown backdrop-blur-xl">
          {options.map((option) => (
            <button
              key={option}
              type="button"
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-border-strong/[0.08] bg-surface py-2.5 pl-10 pr-4 text-sm text-ink-50 placeholder:text-ink-600 backdrop-blur-xl transition-all duration-300 hover:border-accent-400/40 focus:border-accent-400/60 focus:outline-none focus:ring-1 focus:ring-accent-400/30"
              />
            </div>
