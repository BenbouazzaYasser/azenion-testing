          ...
          {project.roles.map((role, i) => (
              ...
              <div key={role.id} className="group relative flex h-full flex-col overflow-hidden rounded-2xl card-surface shadow-card backdrop-blur-xl transition-all duration-500 ease-premium hover:border-accent-400/40">
                ...
                <div className="relative flex flex-1 flex-col p-6 sm:p-7">
                  <div className="flex h-11 w-11 items-center justify-center rounded-xl border border-accent-400/30 bg-accent/[0.08] text-sm font-semibold text-accent-400 transition-all duration-500 ease-premium group-hover:scale-[1.05]">
                    {role.title.charAt(0)}
                  </div>
