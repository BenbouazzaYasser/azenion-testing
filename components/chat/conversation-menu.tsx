  ...
  return (
    <>
      <button
        ...
        className={cn(
          "absolute right-1.5 top-1/2 z-20 flex h-11 w-11 -translate-y-1/2 items-center justify-center rounded-lg text-ink-500 transition-colors duration-200 ease-out",
      ...
      {open && coords && typeof document !== "undefined"
        ? createPortal(
            <div
              ...
              className="fixed z-[90] flex w-[13rem] flex-col overflow-hidden rounded-lg border border-border bg-glass-strong p-1 animate-dropdown-in"
