  ...
  return createPortal(
    ...
    >
      ...
      <div
        ref={dialogRef}
        tabIndex={-1}
        className="relative z-10 w-full max-w-[420px] overflow-hidden rounded-2xl border border-border-strong/[0.08] panel-gradient shadow-dialog backdrop-blur-2xl transition-all duration-200 ease-premium"
      >
